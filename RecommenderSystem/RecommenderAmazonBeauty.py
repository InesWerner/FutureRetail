# https://github.com/RudrenduPaul/Python-Ecommerce-recommendation-system-using-machine-learning/blob/master/Recommendation%20System%20-%20Paul.ipynb
...
print('You bought the product with the Id ' + r + ' you may also be interested in the following products: ')
